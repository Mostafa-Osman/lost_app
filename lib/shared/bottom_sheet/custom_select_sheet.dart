      ...
      return Column(
        ...
        children: [
          Text(title, style: const TextStyle( fontSize: 15,
            fontWeight: FontWeight.w300, fontFamily: 'Tajawal',),),
            ...
            onTap: () {
              if (isDataLoading) {
                if (onLoadingStatePressed != null) {
                  ...
                  showToast(
                      message: 'الرجاء الانتظار', state: ToastStates.warning,);
                }
              } else {
                if (items.isNotEmpty) {
                  if (items.length == 1) {
                    showToast(message: 'خيار واحد متاح',
                  ...
                  showToast(
                      message: onErrorMessage, state: ToastStates.error,);
                }
              }
            },
            child: Container(
