...
class AuthenticationWebService {
  ...
  Future<Map<String, dynamic>> register({
    ...
    final String url = '${AppConst.baseUrl}register';
    final headers = {
  ...
  Future<Map<String, dynamic>> login({
    ...
    //todo remove it after upload backend to server
    await Future.delayed(const Duration(seconds: 3));
    final String url = '${AppConst.baseUrl}login';
    final headers = {
      'Content-Type': 'application/json;charset=UTF-8',
    };
  ...
  Future<Map<String, dynamic>> verifyPhoneNumber({
    ...
    //todo remove it after upload backend to server
    await Future.delayed(const Duration(seconds: 3));
    final String url = '${AppConst.baseUrl}forgot_password';
    final headers = {
      'Content-Type': 'application/json;charset=UTF-8',
    };
  ...
  Future<Map<String, dynamic>> resetPassword({
    ...
    //todo remove it after upload backend to server
    await Future.delayed(const Duration(seconds: 3));
    final String url = '${AppConst.baseUrl}reset_password';
    final headers = {
      'Content-Type': 'application/json;charset=UTF-8',
    };
  ...
  Future<Map<String, dynamic>> updateFcmToken(String fcmToken) async {
    ...
    final String url = '${AppConst.baseUrl}update-fcm-token';
